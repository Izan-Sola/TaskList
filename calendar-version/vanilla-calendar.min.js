/*! name: vanilla-calendar-pro | url: https://github.com/uvarov-frontend/vanilla-calendar-pro */ ! function(e, t) {
    ...
    var e = Object.defineProperty,
        ...
        l = (e, l) => {
            ...
            if (t)
                for (var r of t(l)) n.call(l, r) && s(e, r, l[r]);
            return e
        },
    ...
    class u {
        constructor() {
            var e;
            r(this, "isInit", !1), r(this, "input", !1), r(this, "type", "default"), r(this, "months", 2), r(this, "jumpMonths", 1), r(this, "date", {
                min: "1970-01-01",
                max: "2470-12-31",
                today: new Date
            }), r(this, "settings", {
                ...
                showCalendar: null,
                hideCalendar: null
            }), r(this, "popups", {}), r(this, "CSSClasses", l({}, i)), r(this, "DOMTemplates", {
            ...
            }), r(this, "HTMLElement"), r(this, "HTMLOriginalElement"), r(this, "HTMLInputElement"), r(this, "rangeMin"), r(this, "rangeMax"), r(this, "rangeDisabled"), r(this, "rangeEnabled"), r(this, "selectedDates"), r(this, "selectedHolidays"), r(this, "selectedMonth"), r(this, "selectedYear"), r(this, "selectedHours"), r(this, "selectedMinutes"), r(this, "selectedKeeping"), r(this, "selectedTime"), r(this, "currentType"), r(this, "correctMonths"), r(this, "viewYear"), r(this, "dateMin"), r(this, "dateMax")
        }
    }
    const m = e => `${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,
        g = e => new Date(`${e}T00:00:00`),
        h = e => e.reduce(((e, t) => (t.match(/^(\d{4}-\d{2}-\d{2})$/g) ? e.push(t) : t.replace(/(\d{4}-\d{2}-\d{2}).*?(\d{4}-\d{2}-\d{2})/g, ((t, a, n) => {
            const s = g(a),
                l = g(n),
        ...
        b = e => {
            e.currentType = e.type, (e => {
                ...
                var t, a;
                e.selectedDates = (null == (t = e.settings.selected.dates) ? void 0 : t[0]) ? h(e.settings.selected.dates) : [], e.selectedHolidays = (null == (a = e.settings.selected.holidays) ? void 0 : a[0]) ? h(e.settings.selected.holidays) : []
            })(e), (e => {
        ...
        $ = (e, t, a, n, s, l, r, i) => {
            ...
            e.settings.visibility.weekNumbers && (() => {
            ...
            })(), r ? e.settings.visibility.daysOutside && d.append(o) : d.append(o), ((e, t, a) => {
                var n, s, l, r, i;
                ...
                !d && !o || (null == (l = e.rangeEnabled) ? void 0 : l.includes(t)) || (null == (r = e.rangeDisabled) ? void 0 : r.includes(t)) || (e.rangeDisabled.push(t), null == (i = e.rangeDisabled) || i.sort(((e, t) => +new Date(e) - +new Date(t))))
            })(e, l, s), ((e, t, a, n, s, l, r) => {
                var i, d, o;
                (g(e.rangeMin) > g(l) || g(e.rangeMax) < g(l) || (null == (i = e.rangeDisabled) ? void 0 : i.includes(l)) || !e.settings.selection.month && r || !e.settings.selection.year && g(l).getFullYear() !== t) && (n.classList.add(e.CSSClasses.dayBtnDisabled), n.tabIndex = -1), e.settings.visibility.today && m(e.date.today) === l && n.classList.add(e.CSSClasses.dayBtnToday), !e.settings.visibility.weekend || 0 !== s && 6 !== s || n.classList.add(e.CSSClasses.dayBtnWeekend), (null == (d = e.selectedHolidays) ? void 0 : d.includes(l)) && n.classList.add(e.CSSClasses.dayBtnHoliday), (null == (o = e.selectedDates) ? void 0 : o.includes(l)) && (n.classList.add(e.CSSClasses.dayBtnSelected), e.selectedDates.length > 1 && "multiple-ranged" === e.settings.selection.day && (e.selectedDates[0] === l && a.classList.add(e.CSSClasses.daySelectedFirst), e.selectedDates[e.selectedDates.length - 1] === l && a.classList.add(e.CSSClasses.daySelectedLast), e.selectedDates[0] !== l && e.selectedDates[e.selectedDates.length - 1] !== l && a.classList.add(e.CSSClasses.daySelectedIntermediate)))
            })(e, t, d, o, s, l, r), a.append(d), e.actions.getDays && e.actions.getDays(n, l, d, o, e)
        },
        L = e => {
            ...
            t.forEach(((t, s) => {
                ...
                e.settings.selection.day && t.classList.add(e.CSSClasses.daysSelecting), t.innerHTML = "", ((e, t, a, n, s) => {
                    ...
                    var a;
                    e.popups && (null == (a = Object.entries(e.popups)) || a.forEach((([a, n]) => ((e, t, a, n) => {
        ...
        E = e => {
            ...
            })(e, t, a, l))), null == s || s.forEach(((t, a) => ((e, t, a, n) => {
        ...
        H = (e, t) => {
            ...
            })[t](), [e.selectedMonth, e.selectedYear] = [a.getMonth(), a.getFullYear()], E(e), w(e), L(e)
        },
        ...
        x = (e, t) => {
            const {
                ...
                multiple: () => {
                    i && (a.classList.add(n.calendarMultiple), a.classList.remove(n.calendarMonth, n.calendarYear), a.innerHTML = ((e, t) => t.replace(/<#Multiple>(.*?)<#\/Multiple>/g, ((t, a) => {
                        let n = "";
        ...
        B = (e, t) => {
            ...
            const d = e.jumpMonths > 1 ? e.locale.months.map(((t, a) => s - e.jumpMonths * a)).concat(e.locale.months.map(((t, a) => s + e.jumpMonths * a))).filter((e => e >= 0 && e <= 12)) : Array.from(Array(12).keys()),
        ...
        j = (e, t, a, n) => {
            ...
            })[n](), e.selectedTime = `${e.selectedHours}:${e.selectedMinutes}${e.selectedKeeping?` ${e.selectedKeeping}`:""}`, e.actions.changeTime && e.actions.changeTime(t, e), e.input && e.HTMLInputElement && e.actions.changeToInput && e.actions.changeToInput(t, e)
        },
        R = (e, t, a, n, s, l) => {
            t.addEventListener("input", (t => {
                ...
                i < l && i > 0 ? (a.value = d, e.selectedKeeping = "AM", n.innerText = e.selectedKeeping, j(e, t, d, s)) : (0 === i ? (e.selectedKeeping = "AM", n.innerText = "AM") : (e.selectedKeeping = "PM", n.innerText = "PM"), a.value = y(r.value), j(e, t, y(r.value), s))
            }))
        },
        z = (e, t, a, n, s, l) => {
            a.addEventListener("change", (a => {
                const r = a.target,
                    i = Number(r.value),
                    d = i < 10 ? `0${i}` : `${i}`;
                "hours" === s && 12 === l ? r.value && i <= l && i > 0 ? (r.value = d, t.value = W(d, e.selectedKeeping), j(e, a, d, s)) : r.value && i < 24 && (i > l || 0 === i) ? (0 === i ? (e.selectedKeeping = "AM", n.innerText = "AM") : (e.selectedKeeping = "PM", n.innerText = "PM"), r.value = y(r.value), t.value = d, j(e, a, y(r.value), s)) : r.value = e.selectedHours : r.value && i <= l && i >= 0 ? (r.value = d, t.value = d, j(e, a, d, s)) : "hours" === s ? r.value = e.selectedHours : "minutes" === s && (r.value = e.selectedMinutes)
            }))
        },
        G = (e, t, a) => {
            ...
            O(s, r, e.CSSClasses.isFocus), O(l, i, e.CSSClasses.isFocus), R(e, s, r, d, "hours", n), R(e, l, i, d, "minutes", 0), z(e, s, r, d, "hours", n), z(e, l, i, d, "minutes", 59), d && ((e, t, a) => {
        ...
        V = e => {
            ...
            e.HTMLElement.querySelectorAll(`.${e.CSSClasses.week}`).forEach((a => ((e, t, a) => {
        ...
        ne = e => {
            ...
            (e => {
                ...
                ({
                    ...
                    system: () => ae(e, window.matchMedia("(prefers-color-scheme: dark)"))
        ...
        oe = (e, t) => {
            ...
            if (t) {
                ...
                e.selectedDates = n && !e.settings.selection.cancelableDay ? [t, t] : n && e.settings.selection.cancelableDay ? [] : e.selectedDates.length > 1 ? [t] : [...e.selectedDates, t], null == (a = e.selectedDates) || a.sort(((e, t) => +new Date(e) - +new Date(t)))
            }
            ...
            const n = {
                set: () => {
                    e.HTMLElement.addEventListener("mousemove", ie), document.addEventListener("keydown", de), e.settings.range.disableGaps && (() => {
                        var e, t, a;
                ...
                reset: () => {
                    ...
                    e.selectedDates = e.selectedDates[0] !== e.selectedDates[e.selectedDates.length - 1] ? h([`${t}:${a}`]) : [e.selectedDates[0], e.selectedDates[0]], e.HTMLElement.removeEventListener("mousemove", ie), document.removeEventListener("keydown", de), e.settings.range.disableGaps && se.self && (se.self.rangeMin = se.rangeMin, se.self.rangeMax = se.rangeMax)
                }
            };
        ...
        me = (e, t, a, n) => {
            ...
            if (e.currentType !== a && r) {
                ...
                ({
                    year: () => {
                        if ("multiple" === e.type) {
                            ...
                            a || l ? (e.selectedYear = e.dateMin.getFullYear(), e.selectedMonth = e.dateMin.getMonth()) : n || r ? (e.selectedYear = e.dateMax.getFullYear(), e.selectedMonth = e.dateMax.getMonth()) : e.selectedYear = t
                ...
                })[a](), l[a](), e.currentType = e.type, ne(e)
            })(e, t, a, n, i) : (e.currentType === a && r || "multiple" === e.type && e.currentType === a && d && !o) && (e.currentType = e.type, ne(e))
        },
        ge = e => {
            const t = t => {
                ((e, t) => {
                    const a = t.target.closest(`.${e.CSSClasses.arrow}`);
                    a && (["default", "multiple"].includes(e.currentType) ? H(e, a.dataset.calendarArrow) : "year" === e.currentType && void 0 !== e.viewYear && (e.viewYear += {
                        prev: -15,
                        next: 15
                    } [a.dataset.calendarArrow], N(e, t.target)), e.actions.clickArrow && e.actions.clickArrow(t, e))
                })(e, t), ((e, t) => {
                    var a;
                    ...
                    })[e.settings.selection.day](), null == (a = e.selectedDates) || a.sort(((e, t) => +new Date(e) - +new Date(t))), e.actions.clickDay && e.actions.clickDay(t, e), e.input && e.HTMLInputElement && e.HTMLElement && e.actions.changeToInput && e.actions.changeToInput(t, e);
        ...
        ve = e => {
            ...
            const n = () => ye(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses),
                s = t => {
                    var a;
                    e && t.target !== e.HTMLInputElement && !(null == (a = e.HTMLElement) ? void 0 : a.contains(t.target)) && (e.HTMLInputElement && e.HTMLElement && e.hide(), window.removeEventListener("resize", n), document.removeEventListener("click", s, {
                        capture: !0
                    }))
                };
            return e.HTMLInputElement.addEventListener("click", (() => {
                t ? a.push((() => {
                    ...
                    return a.className = `${e.CSSClasses.calendar} ${e.CSSClasses.calendarToInput} ${e.CSSClasses.calendarHidden}`, e.HTMLElement = a, document.body.append(e.HTMLElement), t = !1, setTimeout((() => {
                        ...
                        holidays: !0,
                        time: !0
                    }), e.actions.initCalendar && e.actions.initCalendar(e), ge(e)
                })()) : (ye(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses), e.show()), window.addEventListener("resize", n), document.addEventListener("click", s, {
                    capture: !0
                })
            })), () => {
                a.forEach((e => e()))
    ...
    return class extends u {
        constructor(e, t) {
            if (super(), r(this, "init", (() => {
                ...
                })(this, e))), r(this, "destroy", (() => (e => {
                    var t, a, n, s;
                    if (!e.isInit) throw new Error(M);
                    e.input ? (null == (a = null == (t = e.HTMLElement) ? void 0 : t.parentElement) || a.removeChild(e.HTMLElement), null == (n = e.HTMLInputElement) || n.replaceWith(e.HTMLOriginalElement), e.HTMLInputElement = void 0) : null == (s = e.HTMLElement) || s.replaceWith(e.HTMLOriginalElement), e.HTMLElement = e.HTMLOriginalElement, e.actions.destroyCalendar && e.actions.destroyCalendar(e)
                })(this))), r(this, "show", (() => {
                    var e;
                ...
                })), this.HTMLElement = "string" == typeof e ? document.querySelector(e) : e, !this.HTMLElement) throw new Error(v(e));
            if (!t) return;
            const a = (e, t) => {
